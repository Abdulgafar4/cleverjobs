...
import { Briefcase, Mail, Lock, User, Building, Sparkles, CheckCircle2, Loader2, ArrowRight, Rocket, Users, Target, Search, TrendingUp, Zap, Shield, Globe, Eye, EyeOff } from 'lucide-react';
                  ...
                  <div className="relative mb-8">
                    <div className="flex gap-2 p-1.5 rounded-2xl bg-slate-100/80 dark:bg-slate-800/80 border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm">
                      <button
                        ...
                        className={`flex-1 px-5 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${activeTab === 'signin'
                      ...
                      <button
                        ...
                        className={`flex-1 px-5 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${activeTab === 'signup'
                            ? 'bg-white dark:bg-slate-700 text-foreground shadow-lg shadow-slate-900/5 dark:shadow-slate-800/20 scale-[1.02]'
                            : 'text-muted-foreground hover:text-foreground hover:bg-white/50 dark:hover:bg-slate-700/50'
                          }`}
                      >
                          ...
                          <div className="space-y-2.5">
                            ...
                            <div className="relative group">
                              ...
                              <Input
                                ...
                                className="pl-12 pr-12 h-14 border-2 border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 focus:border-primary focus:ring-2 focus:ring-primary/20 rounded-xl text-base transition-all duration-200 relative z-0"
                                required
                              />
                              <Button
                                type="button"
                                variant="ghost"
                                size="sm"
                                className="absolute right-2 top-1/2 -translate-y-1/2 h-10 w-10 text-muted-foreground hover:text-foreground z-10"
                            ...
                            {password && (
                              ...
                              >
                                ...
                                {passwordStrength.label && (
                                  <p className={`text-xs font-semibold ${passwordStrength.strength >= 3 ? 'text-green-600 dark:text-green-400' :
